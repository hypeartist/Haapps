...
{
	public unsafe struct RasterizerScanlineAA64<TRasterizerConverter, TRasterizerClipper> : IRasterizerScanline
		where TRasterizerConverter : unmanaged, IRasterizerConverter64
		where TRasterizerClipper : unmanaged, IRasterizerClipper64<TRasterizerConverter>
	{
		private enum Status
		{
			Initial,
		...
		public RasterizerScanlineAA64(RasterizerData<Cell> data) : this()
		{
