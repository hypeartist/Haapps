...
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Adapters;
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Adapters.Entities;
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Entities;
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Handlers;
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Parse;
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Utils;

namespace Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Dom
{
    /// <summary>
    ...
    internal class CssBox : CssBoxProperties, IDisposable
    {
        ...
        {
            get => _htmlContainer ?? (_htmlContainer = _parentBox != null ? _parentBox.HtmlContainer : null);
        ...
        /// </summary>
        public List<CssBox> Boxes => _boxes;
        ...
        /// </summary>
        internal List<CssLineBox> LineBoxes { get; } = new List<CssLineBox>();

        /// <summary>
        /// Gets the linebox(es) that contains words of this box (if inline)
        /// </summary>
        internal List<CssLineBox> ParentLineBoxes { get; } = new List<CssLineBox>();

        /// <summary>
        /// Gets the rectangles where this box should be painted
        /// </summary>
        internal Dictionary<CssLineBox, RRect> Rectangles => _rectangles;
