...
namespace Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Parse
{
    /// <summary>
    ...
    internal sealed class CssParser
    {
        ...
        {
	        return _valueParser.TryGetColor(str, idx, length, out var color) ? str.Substring(idx, length) : null;
        }
    }
}