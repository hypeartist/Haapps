...
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Dom;
...
namespace Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core
{
    /// <summary>
    ...
    public sealed class HtmlContainerInt : IDisposable
    {
        ...
        /// parser for CSS data
        /// </summary>
        internal CssParser CssParser => _cssParser;
