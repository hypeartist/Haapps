...
namespace Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core.Entities
{
    /// <summary>
    ...
    public sealed class LinkElementData<T>
    {
        ...
        /// </summary>
        public bool IsAnchor => _href.Length > 0 && _href[0] == '#';

        /// <summary>
        /// Return the id of the element this anchor link is referencing.
        /// </summary>
        public string AnchorId => IsAnchor && _href.Length > 1 ? _href.Substring(1) : string.Empty;

        public override string ToString()
        {
            return $"Id: {_id}, Href: {_href}, Rectangle: {_rectangle}";
        }
    }
}