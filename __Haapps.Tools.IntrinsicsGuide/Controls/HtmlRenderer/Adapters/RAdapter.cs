...
using Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Core;
...
namespace Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.Adapters
{
    /// <summary>
    ...
    public abstract class RAdapter
    {
        ...
        /// </summary>
        public CssData DefaultCssData => _defaultCssData ?? (_defaultCssData = CssData.Parse(this, CssDefaults.DefaultStyleSheet, false));
