using Haapps.Tools.IntrinsicsGuide.Controls.FastColoredTextBox;
using Haapps.Tools.IntrinsicsGuide.Controls.HintTextBox;
...
namespace Haapps.Tools.IntrinsicsGuide
{
	partial class AppForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.olvColumn3 = ((Fluent.OLVColumn)(new Fluent.OLVColumn()));
			this.olvColumn1 = ((Fluent.OLVColumn)(new Fluent.OLVColumn()));
			this.olvColumn2 = ((Fluent.OLVColumn)(new Fluent.OLVColumn()));
			this.olvColumn4 = ((Fluent.OLVColumn)(new Fluent.OLVColumn()));
			...
			this._hlblSignture = new Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.WinForms.HtmlLabel();
			...
			this._hlblNetCoreSignture = new Haapps.Tools.IntrinsicsGuide.Controls.HtmlRenderer.WinForms.HtmlLabel();
			this._lblNetCoreClass = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this._lblDescription = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this._fctbOperation = new Haapps.Tools.IntrinsicsGuide.Controls.FastColoredTextBox.FastColoredTextBox();
			this.panel3 = new System.Windows.Forms.Panel();
			this._htbSearch = new Haapps.Tools.IntrinsicsGuide.Controls.HintTextBox.HintTextBox(this.components);
			this._rbIntel = new System.Windows.Forms.RadioButton();
			this._rbNet = new System.Windows.Forms.RadioButton();
			...
			this._tpSearchResults.SuspendLayout();
			...
			this._tlpSynopsis.Controls.Add(this.label5, 0, 4);
			this._tlpSynopsis.Controls.Add(this.label17, 0, 5);
			...
			this._tlpSynopsis.Controls.Add(this._lblNetCoreClass, 1, 4);
			...
			this.label5.Margin = new System.Windows.Forms.Padding(0, 0, 0, 1);
			this.label5.Name = "label5";
			this.label5.Padding = new System.Windows.Forms.Padding(10, 3, 10, 2);
			this.label5.Size = new System.Drawing.Size(101, 20);
			this.label5.TabIndex = 13;
			this.label5.Text = ".NET class:";
			...
			this.label17.Margin = new System.Windows.Forms.Padding(0, 0, 0, 1);
			this.label17.Name = "label17";
			this.label17.Padding = new System.Windows.Forms.Padding(10, 3, 5, 2);
			this.label17.Size = new System.Drawing.Size(101, 19);
			this.label17.TabIndex = 9;
			this.label17.Text = ".NET signature:";
			...
			// _lblNetCoreClass
			// 
			this._lblNetCoreClass.AutoSize = true;
			this._lblNetCoreClass.ContextMenuStrip = this._cmsMiscOps;
			this._lblNetCoreClass.Dock = System.Windows.Forms.DockStyle.Fill;
			this._lblNetCoreClass.Font = new System.Drawing.Font("Segoe UI", 12F, ((System.Drawing.FontStyle)((System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Italic))), System.Drawing.GraphicsUnit.Pixel, ((byte)(0)));
			this._lblNetCoreClass.ForeColor = System.Drawing.Color.Black;
			this._lblNetCoreClass.Location = new System.Drawing.Point(101, 84);
			this._lblNetCoreClass.Margin = new System.Windows.Forms.Padding(0);
			this._lblNetCoreClass.Name = "_lblNetCoreClass";
			this._lblNetCoreClass.Padding = new System.Windows.Forms.Padding(0, 1, 0, 1);
			this._lblNetCoreClass.Size = new System.Drawing.Size(573, 21);
			this._lblNetCoreClass.TabIndex = 14;
			this._lblNetCoreClass.Text = "Class";
			this._lblNetCoreClass.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// label6
			// 
    ...
    "(?<range>:)\\s*(?<range>[^;]+);";
			...
			this.panel3.Controls.Add(this._rbNet);
			...
			// _rbNet
			// 
			this._rbNet.AutoSize = true;
			this._rbNet.Dock = System.Windows.Forms.DockStyle.Right;
			this._rbNet.Location = new System.Drawing.Point(562, 5);
			this._rbNet.Margin = new System.Windows.Forms.Padding(0);
			this._rbNet.Name = "_rbNet";
			this._rbNet.Size = new System.Drawing.Size(49, 25);
			this._rbNet.TabIndex = 2;
			this._rbNet.Text = ".NET";
			this._rbNet.UseVisualStyleBackColor = true;
			this._rbNet.CheckedChanged += new System.EventHandler(this.On_rbSearchBy_CheckedChanged);
			// 
			// _rbInstruction
			// 
		...
		private Controls.HtmlRenderer.WinForms.HtmlLabel _hlblNetCoreSignture;
		private Controls.HtmlRenderer.WinForms.HtmlLabel _hlblSignture;
		private Fluent.Lists.FastListView _flvSearchResults;
		private Fluent.OLVColumn olvColumn1;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Label _lblNetCoreClass;
		private System.Windows.Forms.ImageList imageList1;
		private Fluent.OLVColumn olvColumn3;
		...
		private System.Windows.Forms.RadioButton _rbNet;
		private HintTextBox _htbSearch;
		private System.Windows.Forms.RadioButton _rbInstruction;
		private Fluent.OLVColumn olvColumn2;
		private Fluent.OLVColumn olvColumn4;
	}
}
