...
{
    /// <summary>
    /// Low level handling of Html Renderer logic, this class is used by <see cref="Core.Parse.HtmlParser"/>, 
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {
	        return HtmlContainerInt.GetLinks().Select(link => new LinkElementData<Rect>(link.Id, link.Href, Utils.Convert(link.Rectangle))).ToList();
        }
