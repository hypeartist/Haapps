...
namespace WindowsFormsApp1
{
	public partial class AppForm : Form
	{
		...
		private IEnumerable<NetCoreIntrinsicInfo> _netCoreIntrinsicData;
		...
		private IEnumerable<NetCoreIntrinsicInfo> NetCoreIntrinsicData
		{
			set
			{
				void OnSet()
				{
					_netCoreIntrinsicData = value;
					toolStripProgressBar1.Style = ProgressBarStyle.Blocks;
					FilterData().ConfigureAwait(false);
				}
		...
		protected override async void OnLoad(EventArgs e)
		{
			...
			NetCoreIntrinsicData = await NetCoreIntrinsicInfo.Collect();
		}
